    ...
    <>
      ...
      {isOpen && (
        ...
        >
          <div className="">
            <Button
              className="absolute top-2 right-2 text-white text-2xl font-bold z-10 bg-black bg-opacity-30"
              size={'icon'}
            ...
            <Button
              className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white text-xl font-bold bg-black bg-opacity-30 z-10"
              onClick={prevImage}
              size={'icon'}
            >
              ◀
            ...
            <Button
              className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white text-xl bg-black bg-opacity-30 font-bold z-10"
              size={'icon'}
              onClick={nextImage}
            >
              ▶
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 space-x-4 ">
              <Button
                onClick={zoomOut}
                size={'icon'}
                className="text-white text-xl px-4 py-2 rounded-lg bg-black bg-opacity-30"
              >
                -
              </Button>
              <Button
